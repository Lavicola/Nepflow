...
export function cloneMultiHybridIvPost(http: HttpClient, rootUrl: string, params: CloneMultiHybridIvPost$Params, context?: HttpContext): Observable<StrictHttpResponse<HybridCloneDto>> {
