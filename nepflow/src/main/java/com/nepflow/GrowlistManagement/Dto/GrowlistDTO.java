...
public class GrowlistDTO {
  ...
  @Valid
  private List<@Valid LabelSpecimenDTO> specimens = new ArrayList<>();
  ...
  */
  ...
  public GrowlistDTO specimens(List<@Valid LabelSpecimenDTO> specimens) {
    this.specimens = specimens;
    return this;
  }

  public GrowlistDTO addSpecimensItem(LabelSpecimenDTO specimensItem) {
  ...
  */
  ...
  public List<@Valid LabelSpecimenDTO> getSpecimens() {
    return specimens;
  }

  public void setSpecimens(List<@Valid LabelSpecimenDTO> specimens) {
    this.specimens = specimens;
  }
