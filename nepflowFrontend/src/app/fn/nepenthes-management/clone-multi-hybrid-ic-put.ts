...
export function cloneMultiHybridIcPut(http: HttpClient, rootUrl: string, params: CloneMultiHybridIcPut$Params, context?: HttpContext): Observable<StrictHttpResponse<IcCloneDto>> {
