...
export function cloneMultiHybridIvPut(http: HttpClient, rootUrl: string, params: CloneMultiHybridIvPut$Params, context?: HttpContext): Observable<StrictHttpResponse<IvCloneDto>> {
