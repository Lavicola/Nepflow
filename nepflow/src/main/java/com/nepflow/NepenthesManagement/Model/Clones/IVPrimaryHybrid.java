...
/**
 * Model which represents a PrimaryHybrid ouf of a seed which is propagated in IV.
 *
...
public class IVPrimaryHybrid extends IVClone {
     ...
     */
    public IVPrimaryHybrid(final Label label, final String cloneId, final Sex sex, final Location location, final Producer producer) {
