...
/**
 * Model which represents a SpeciesClone ouf of a seed which is propagated in IV.
 *
...
public class IVSpeciesClone extends IVClone {
     ...
     */
    public IVSpeciesClone(final Label label, final String cloneId, final Sex sex, final Location location, final Producer producer) {
